        ...
        <div className="absolute inset-0 bg-slate-950 flex flex-col pt-5">
          ...
          <div className="px-4 pt-2 pb-3 flex items-center justify-between">
            <div>
              ...
              <p className="text-[11px] font-bold text-white tracking-wide">Geon VTS</p>
            </div>
            ...
            <div className="flex items-center gap-4 pt-2 animate-fade-up opacity-0" style={{ animationFillMode: "forwards", animationDelay: "500ms" }}>
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  <strong className="text-slate-700">1,200+</strong> businesses trust Geon VTS
                </p>
              </div>
            </div>
          </div>
...
//     >
//       {/* Phone body */}
//       <div className="absolute inset-0 bg-slate-900 rounded-[32px] border-[5px] border-slate-800" />

//       {/* Side buttons */}
//       <div className="absolute -left-[7px] top-[60px] w-[5px] h-8 bg-slate-700 rounded-l-md" />
//       <div className="absolute -left-[7px] top-[100px] w-[5px] h-10 bg-slate-700 rounded-l-md" />
//       <div className="absolute -right-[7px] top-[75px] w-[5px] h-12 bg-slate-700 rounded-r-md" />

//       {/* Screen bezel */}
//       <div className="absolute inset-[5px] bg-slate-900 rounded-[28px] overflow-hidden">
//         {/* Notch */}
//         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-16 h-4 bg-slate-900 rounded-b-xl z-10 flex items-center justify-center gap-1.5">
//           <div className="w-1.5 h-1.5 rounded-full bg-slate-700" />
...
//             <span className="text-[7px] text-slate-400 font-semibold">9:41</span>
//             <div className="flex items-center gap-1">
//               <div className="flex gap-0.5 items-end">
//                 {[2, 3, 4, 5].map((h, i) => (
//                   <div key={i} className="w-0.5 rounded-sm bg-slate-400" style={{ height: h }} />
//                 ))}
//               </div>
//               <div className="w-3 h-1.5 border border-slate-400 rounded-[2px] relative">
//                 <div className="absolute inset-[1px] left-[1px] right-[2px] bg-slate-400 rounded-[1px]" />
//               </div>
//             </div>
//           </div>
...
//             <div>
//               <p className="text-[6px] text-slate-500">Welcome back</p>
//               <p className="text-[8px] font-bold text-white">Geon VTS</p>
//             </div>
...
//             {[
//               { label: "Running", val: "12", color: "bg-brand-500" },
//               { label: "Stopped", val: "5", color: "bg-red-500" },
//               { label: "Idle", val: "3", color: "bg-amber-400" },
//             ].map((s) => (
//               <div key={s.label} className="flex-1 bg-slate-800 rounded-lg p-1.5 text-center">
//                 <div className={`text-[8px] font-bold text-white`}>{s.val}</div>
//                 <div className="text-[5px] text-slate-400 mt-0.5">{s.label}</div>
//               </div>
//             ))}
//           </div>

//           {/* Mini map */}
//           <div className="mx-3 flex-1 bg-slate-800 rounded-xl overflow-hidden relative mb-2">
//             <svg className="absolute inset-0 w-full h-full opacity-30" xmlns="http://www.w3.org/2000/svg">
//               <defs>
//                 <pattern id="mgrid" width="12" height="12" patternUnits="userSpaceOnUse">
//                   <path d="M 12 0 L 0 0 0 12" fill="none" stroke="#64748b" strokeWidth="0.4" />
//                 </pattern>
//               </defs>
//               <rect width="100%" height="100%" fill="url(#mgrid)" />
//             </svg>
//             <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
//               <line x1="0" y1="50%" x2="100%" y2="45%" stroke="#334155" strokeWidth="2" />
//               <line x1="40%" y1="0" x2="38%" y2="100%" stroke="#334155" strokeWidth="1.5" />
//               <polyline points="5,30 30,22 60,28 90,18 115,23" fill="none" stroke="#13b368" strokeWidth="1.5" strokeDasharray="3 2" opacity="0.8" />
//             </svg>
//             {/* Marker */}
//             <div className="absolute top-[30%] left-[35%]">
//               <div className="relative">
//                 <div className="absolute inset-0 w-2.5 h-2.5 rounded-full bg-brand-400 animate-ping opacity-50" />
...
//             {[
//               { id: "DHA-2341", speed: "62 km/h", status: "Running", color: "text-brand-400" },
//               { id: "CTG-1190", speed: "Stopped", status: "Stopped", color: "text-red-400" },
//             ].map((v) => (
//               <div key={v.id} className="flex items-center justify-between bg-slate-800 rounded-lg px-2 py-1">
//                 <span className="text-[6px] font-semibold text-slate-300">{v.id}</span>
//                 <span className={`text-[6px] font-bold ${v.color}`}>{v.speed}</span>
//               </div>
//             ))}
//           </div>

//           {/* Bottom nav */}
//           <div className="flex items-center justify-around px-3 py-2 border-t border-slate-800">
//             {["📍", "📊", "🔔", "👤"].map((icon, i) => (
//               <div key={i} className={`text-[10px] ${i === 0 ? "opacity-100" : "opacity-40"}`}>{icon}</div>
//             ))}
//           </div>

//           {/* Home indicator */}
//           <div className="flex justify-center pb-1.5">
//             <div className="w-8 h-[3px] bg-slate-600 rounded-full" />
//           </div>
//         </div>
//       </div>
//     </div>
...
//             {/* Headline */}
//             <div className="animate-fade-up opacity-0 animate-delay-100" style={{ animationFillMode: "forwards", animationDelay: "100ms" }}>
//               <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-800 leading-tight text-slate-900">
//                 Smart Vehicle
//                 <br />
//                 <span className="text-gradient">Tracking Made</span>
...
//                   ))}
//                 </div>
//                 <p className="text-xs text-slate-500 mt-0.5"><strong className="text-slate-700">1,200+</strong> businesses trust Geon VTS</p>
//               </div>
//             </div>
//           </div>

//           {/* Right: Download App */}
//           {/* ── Download App button + rotated phone mockup ── */}
//           <div className="animate-fade-up opacity-0" style={{ animationFillMode: "forwards", animationDelay: "480ms" }}>
//             {/* Download App button */}
//             {/* Phone mockup — shown below the button, hidden on very small screens to preserve layout */}
...
// "use client";
// import { ArrowRight, CheckCircle, MapPin, Play, Shield, Zap } from "lucide-react";
...
// function MapMockup() {
//   return (
//     <div className="relative w-full h-full bg-slate-50 overflow-hidden rounded-2xl">
...
//       {/* Map "roads" */}
//       <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
//         <line x1="0" y1="45%" x2="100%" y2="40%" stroke="#cbd5e1" strokeWidth="3" />
//         <line x1="0" y1="70%" x2="100%" y2="68%" stroke="#cbd5e1" strokeWidth="5" />
//         <line x1="30%" y1="0" x2="35%" y2="100%" stroke="#cbd5e1" strokeWidth="3" />
//         <line x1="65%" y1="0" x2="60%" y2="100%" stroke="#cbd5e1" strokeWidth="4" />
//         <line x1="10%" y1="20%" x2="50%" y2="55%" stroke="#e2e8f0" strokeWidth="2" />
//         <line x1="50%" y1="55%" x2="90%" y2="30%" stroke="#e2e8f0" strokeWidth="2" />
//         {/* Green route path */}
//         <polyline
//           points="10,120 80,90 160,110 240,80 320,95 400,70 480,85 540,65"
//           fill="none"
//           stroke="#13b368"
//           strokeWidth="3"
//           strokeDasharray="6 3"
...
//       {/* Vehicle markers */}
//       {/* Running vehicle */}
//       <div className="absolute top-[28%] left-[22%] flex flex-col items-center">
//         <div className="relative">
//           <div className="absolute inset-0 w-5 h-5 rounded-full bg-brand-400 animate-ping opacity-40" />
//           <div className="w-5 h-5 rounded-full bg-brand-500 border-2 border-white shadow-lg flex items-center justify-center">
//             <div className="w-2 h-2 rounded-full bg-white" />
//           </div>
//         </div>
//         <div className="mt-1 bg-white rounded-lg px-2 py-1 shadow-md text-xs font-semibold text-brand-700 border border-brand-100 whitespace-nowrap">
//           🚗 DHA-2341
//         </div>
//       </div>

//       {/* Running vehicle 2 */}
//       <div className="absolute top-[42%] left-[58%] flex flex-col items-center">
//         <div className="relative">
//           <div className="absolute inset-0 w-5 h-5 rounded-full bg-brand-400 animate-ping opacity-40 animation-delay-300" style={{ animationDelay: '0.3s' }} />
//           <div className="w-5 h-5 rounded-full bg-brand-500 border-2 border-white shadow-lg flex items-center justify-center">
//             <div className="w-2 h-2 rounded-full bg-white" />
//           </div>
//         </div>
...
//       {/* Stopped vehicle */}
//       <div className="absolute top-[60%] left-[38%] flex flex-col items-center">
//         <div className="w-5 h-5 rounded-full bg-red-500 border-2 border-white shadow-lg flex items-center justify-center">
//           <div className="w-2 h-2 rounded-full bg-white" />
//         </div>
//         <div className="mt-1 bg-white rounded-lg px-2 py-1 shadow-md text-xs font-semibold text-red-600 border border-red-100 whitespace-nowrap">
//           🔴 CTG-1190
//         </div>
//       </div>

//       {/* Idle vehicle */}
//       <div className="absolute top-[18%] left-[70%] flex flex-col items-center">
//         <div className="w-5 h-5 rounded-full bg-amber-400 border-2 border-white shadow-lg flex items-center justify-center">
//           <div className="w-2 h-2 rounded-full bg-white" />
//         </div>
//         <div className="mt-1 bg-white rounded-lg px-2 py-1 shadow-md text-xs font-semibold text-amber-600 border border-amber-100 whitespace-nowrap">
//           🟡 SYL-0088
//         </div>
//       </div>

//       {/* Speed indicator bottom-left */}
//       <div className="absolute bottom-4 left-4 bg-white rounded-xl p-3 shadow-lg border border-slate-100 min-w-[120px]">
//         <div className="text-xs text-slate-500 mb-0.5">DHA-2341</div>
//         <div className="text-2xl font-display font-bold text-brand-600">62 <span className="text-sm font-normal text-slate-500">km/h</span></div>
//         <div className="flex items-center gap-1 mt-1">
//           <div className="w-2 h-2 rounded-full bg-brand-400 animate-pulse" />
//           <span className="text-xs text-brand-600 font-semibold">Running</span>
//         </div>
//       </div>

//       {/* Mini stats top-right */}
//       <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-xl p-3 shadow-lg border border-slate-100 space-y-1.5">
//         <div className="flex items-center gap-2">
//           <div className="w-2 h-2 rounded-full bg-brand-500" />
//           <span className="text-xs text-slate-600">Running: <strong>12</strong></span>
//         </div>
//         <div className="flex items-center gap-2">
//           <div className="w-2 h-2 rounded-full bg-red-500" />
//           <span className="text-xs text-slate-600">Stopped: <strong>5</strong></span>
//         </div>
//         <div className="flex items-center gap-2">
//           <div className="w-2 h-2 rounded-full bg-amber-400" />
//           <span className="text-xs text-slate-600">Idle: <strong>3</strong></span>
//         </div>
//       </div>
//     </div>
//   );
...
//   return (
//     <div className="w-full rounded-2xl bg-white shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden">
//       {/* Top bar */}
...
//         {/* Sidebar */}
//         <div className="hidden sm:flex flex-col w-14 bg-slate-900 py-4 items-center gap-4">
//           <div className="w-8 h-8 rounded-xl bg-brand-500 flex items-center justify-center">
//             <MapPin className="w-4 h-4 text-white" />
//           </div>
//           {["📍", "📊", "🔔", "👤", "⚙️"].map((icon, i) => (
//             <button key={i} className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm transition-colors ${i === 0 ? "bg-brand-500/20 text-brand-400" : "text-slate-500 hover:text-slate-300"}`}>
//               {icon}
//             </button>
//           ))}
//         </div>
...
//             <div className="text-sm font-semibold text-slate-800">Live Tracking</div>
//             <div className="flex items-center gap-2">
//               <div className="w-2 h-2 rounded-full bg-brand-500 animate-pulse" />
//               <span className="text-xs text-brand-600 font-medium">20 Vehicles Online</span>
//             </div>
//           </div>

//           {/* Content: stat cards + map */}
//           <div className="flex-1 overflow-hidden p-3 bg-slate-50 space-y-3">
//             {/* Stat cards */}
//             <div className="grid grid-cols-4 gap-2">
//               {[
//                 { label: "Total Fleet", val: "20", color: "text-slate-700", bg: "bg-white" },
//                 { label: "Running", val: "12", color: "text-brand-600", bg: "bg-brand-50" },
//                 { label: "Stopped", val: "5", color: "text-red-600", bg: "bg-red-50" },
//                 { label: "Idle", val: "3", color: "text-amber-600", bg: "bg-amber-50" },
//               ].map((s) => (
//                 <div key={s.label} className={`${s.bg} rounded-xl p-2 border border-slate-100 text-center`}>
//                   <div className={`text-lg font-display font-bold ${s.color}`}>{s.val}</div>
...
//             {/* Map area */}
//             <div className="flex-1 h-[260px] md:h-[300px]">
//               <MapMockup />
//             </div>
//           </div>
//         </div>
...
//           <div className="animate-fade-up opacity-0 animate-float" style={{ animationFillMode: "forwards", animationDelay: "300ms" }}>
//             <DashboardMockup />
//           </div>
//         </div>
//       </div>
